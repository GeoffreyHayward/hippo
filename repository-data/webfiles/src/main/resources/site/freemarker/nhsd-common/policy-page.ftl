...
<#if parentWork.publicationStyle.publicationStyle?? && (!(document.publicationStyle.publicationStyle)?? || document.publicationStyle.publicationStyle == 'parent')>
...
<#elseif document.publicationStyle.publicationStyle?? && document.publicationStyle.publicationStyle?length gt 0>
    <#assign imageDocument = document />
    <#assign publicationStyle = document.publicationStyle.publicationStyle />
</#if>

<#--  Use current values, else use parent values, if any  -->
<#if document.publicationStyle.imageAltText??>
    <#assign bannerImageAltText = document.publicationStyle.imageAltText />
<#elseif parentWork.publicationStyle.imageAltText??>
    <#assign bannerImageAltText = parentWork.publicationStyle.imageAltText />
</#if>
